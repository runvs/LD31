...
class Enemy extends FlxSprite
{
	...
	public function new(X:Float=0, Y:Float=0, playstate:PlayState, level:Float, seed:Float) 
	{
        ...
        _healthCurrent = _healthMax = GameProperties.EnemyHealthDefault * (1.0 + (Math.pow(_level*0.125, 0.125)));
        ...
        _personalVelocityAdd = GameProperties.EnemyMovementVelocityAdd * Math.pow(_level * 0.55, 1.1) * (1.0 + _seed);
